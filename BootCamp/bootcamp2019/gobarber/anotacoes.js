  ...
  modules: [
    ...
    },
    {
      ...
      dicas: [
        {
          relacionamento:
            'quando se tem mais de 1 relacionamento devemos colocar "as" no belongsTo ',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      obs:
        'para instalar a ultima adicione @next ex: yarn install data-fns@next',
    },
    {
      nome: 'mongoose',
    ...
    },
    {
      nome: 'bee-queue',
      desc:
        'gerenciamento de filas, exemplo: manda enviar email, e se falhou(smtp offline) tenta novamente em x minutos',
      desc2:
        'existe outros com mais opcoes(prioridade por exemplo) mas o bee-queue é mais rapido por ser leve',
    },
    {
      nome: 'express-async-errors',
      desc:
        'por padrao o express nao reporta os erros nos methodos async, este modulo ativa isto',
    },
    {
      nome: 'youch',
    ...
    {
      nome: 'cors',
      desc: 'permite acesso de um endereço especifico',
    },
  ],
  docker: [
    {
      banco: [
        ...
        },
        {
          banco_redis: {
            ...
            obs:
              'banco de chave/valor muiiito rapido, porem nao oferece template como o mongo',
            obs2:
              'alpine indica só com as features mais essenciais, assim fica mais leve ',
          },
        },
      ],
    },
      ...
      errors: [
        {
          ...
          desc2:
            'uma possibilidade é criar um issue no github e depois podemos repassar para algum arrumar o bug',
          url: 'sentry.io',
        },
      ],
    },
      ...
      email: [
        {
          ...
          desc2:
            'o email vai chegar apenas no mailtrap e nao no destinatario real',
        },
      ],
    },
  ],
